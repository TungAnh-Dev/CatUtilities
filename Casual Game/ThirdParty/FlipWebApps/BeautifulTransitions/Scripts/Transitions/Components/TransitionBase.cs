...
namespace BeautifulTransitions.Scripts.Transitions.Components
{
    ...
    public abstract class TransitionBase : MonoBehaviour {
        ...
        public virtual void TransitionInWithDelay(float delay)
        {
            Invoke("TransitionIn", delay);
        }
        public virtual void TransitionOutWithDelay(float delay)
        {
            Invoke("TransitionOut", delay);
        }
        /// <summary>
